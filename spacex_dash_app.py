...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                # dcc.Dropdown(id='site-dropdown',...)
                                  dcc.Dropdown(id='site-dropdown',
                                                ...
                                                value='ALL',
                                                placeholder="Select a Laucn Site here",
                                                searchable=True
                                                ),
                                html.Br(),
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        pie_fig = px.pie(class_pie, values='class count', names='class', title="Success Launches for site: " + str(entered_site))
        return pie_fig
...
def get_scatter(entered_site,slider_range):
    min1 = slider_range[0]
    max1 = slider_range[1]
    filtered_df = spacex_df[spacex_df['Payload Mass (kg)'].between(min1,max1)]
    if entered_site == 'ALL':
